...
func hostProxyMiddleware() gin.HandlerFunc {
	...
	corsOrigins := map[string]bool{
		...
		"https://app.liquidity.io":      true,
		"https://exchange.liquidity.io": true,
		"https://exchange.satschel.com": true,
		"https://superadmin.satschel.com": true,
		"https://id.satschel.com":         true,
		// Testnet
		"https://exchange.test.satschel.com":  true,
		"https://superadmin.test.satschel.com": true,
		"https://id.test.satschel.com":         true,
		// Devnet
		"https://exchange.dev.satschel.com":  true,
		"https://superadmin.dev.satschel.com": true,
		"https://id.dev.satschel.com":         true,
		"https://swap.dev.satschel.com":       true,
		"https://api.dev.satschel.com":        true,
		// Localhost
